...
def update_recipe(current_user: UserViewDTO = Depends(get_current_user),
        ...
        "title": "cheese Pizza",
        "ingredients": "Dough, tomato souse, mozzarella, cheddar, feta",
        "steps": "1.stretch the dough 2.put on the tomato souse, 3.spread the mozzarella and layer all the cheese",
        "category": "pizzas",
        "photo": "photo.jpeg/photo_path",
    }),
    db: Session = Depends(get_db)
